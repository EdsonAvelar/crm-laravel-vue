...
class AdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Busca usuários, filtrando pelo nome ou email se houver um termo de busca
        $users = User::query()
            ...
            ->appends(['search' => $search]); // Mantém o valor de busca na paginação


        // Retorna os dados com Inertia
