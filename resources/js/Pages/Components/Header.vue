            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    <li class="nav-item theme-logo">
                        <router-link to="/">
                            <img src="/public/assets/images/logo.svg" class="navbar-logo" alt="logo" />
                        </router-link>
                    </li>
                ...
                <div class="navbar-item flex-row ms-md-auto">
                    ...
                    <div class="dropdown nav-item language-dropdown btn-group">
                        <a href="javascript:;" id="ddllang" data-bs-toggle="dropdown" aria-expanded="false"
                            ...
                            <img v-if="selectedLang" :src="`/public/assets/images/flags/${selectedLang.code}.png`"
                            ...
                            <perfect-scrollbar>
                                <li v-for="item in countryList" :key="item.code">
                                    <a href="javascript:;" class="dropdown-item d-flex align-items-center"
                                        ...
                                        <img :src="`/public/assets/images/flags/${item.code}.png`" class="flag-width"
                                            alt="" />
                                        <span>{{ item.name }}</span>
                                    </a>
                                </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right m-0" aria-labelledby="ddlmsg">
                            ...
                            <li role="presentation">
                                <a role="menuitem" href="#" target="_self" class="dropdown-item">
                                    <div class="media media">
                                        <div class="media-aside align-self-start">
                                            <img src="/public/assets/images/profile-15.jpeg" alt="avatar" />
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="dropdown nav-item user-profile-dropdown btn-group">
                        <a href="javascript:;" id="ddluser" data-bs-toggle="dropdown" aria-expanded="false"
                            ...
                            <img src="/public/assets/images/profile-16.jpeg" alt="avatar" />
                        </a>
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled">
                            ...
                            <li>
                                <router-link to="/index2">{{ ('analytics') }}</router-link>
                            </li>
                        </ul>
                    </li>
